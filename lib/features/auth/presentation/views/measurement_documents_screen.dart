...
class MeasurementDocumentsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final docsAsync = ref.watch(measurementDocsForUserProvider(uidToLoad));
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Measurement Documents'),
      ),
      body: docsAsync.when(
        ...
        data: (docs) {
          if (docs.isEmpty) {
            return const Center(
              child: Text(
                'There are no measurement documents...',
          ...
          return ListView.separated(
            ...
            itemBuilder: (ctx, i) {
              ...
              final isImage =
                  d.url.toLowerCase().endsWith('.jpg') ||
                  d.url.toLowerCase().endsWith('.png') ||
                  d.url.toLowerCase().startsWith('image/');
              ...
              return ListTile(
                ...
                onTap: () => _showAttachmentOptions(context, d.url, d.name),
                ...
                trailing:
                    canDelete
                        ? IconButton(
                          ...
                          onPressed: () async {
                            // Șterge documentul din Firestore (colecția measurement_documents)
                            final uid =
